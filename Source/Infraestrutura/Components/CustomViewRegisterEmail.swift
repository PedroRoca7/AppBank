...
final class CustomViewRegisterEmail: UIView {
    ...
    private lazy var provideYourEmailLabel: UILabel = {
        let element = UILabel()
        element.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func setupSubViews() {
        ...
        stackView.addArrangedSubview(provideYourEmailLabel)
